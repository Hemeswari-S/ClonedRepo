...
export default function DesignationBadge() {
  ...
  const Get = () => {
    axios.get(`${RestAPIURL}/Dashboard/getDesBadge`).then((result) => {
      setData(result.data);
...
useEffect(Get,[])
  return (
<>    <div className={`card rounded card-xxl-stretch`} style={{ background: "#FDBCB4"  }}>
          ...
          <div className="text-center">
            <div className=" d-flex flex-column p-4">
              <p className="card-label fw-bold fs-4 mb-1 ">Designation</p>
            ...
            <div className="d-flex justify-content-center gap-5 mb-4">
              <div className="">
                ...
                <span className="badge badge-light-success fs-8 fw-bold rounded">
                  ...
                  {/* {activeEmp}% */}
                  <Badge style={{ backgroundColor: Styles.VarGreen2,borderRadius:2 }} count={Data.ActiveDesCount}/>
              ...
              <div className="">
                ...
                <span className="badge badge-light-danger fs-8 fw-bold rounded">
                  ...
                  <Badge style={{ backgroundColor: Styles.VarGreen2,borderRadius:2 }} count={Data.InactiveDesCount}/>
                  {/* {resignedEmp}% */}
                </span>
              </div>
            </div>
